...
@section('content')
    <div class="mb-8 sm:mb-16 mt-4">
        <h5 class="text-lg sm:text-xl md:text-2xl font-extrabold text-slate-800 mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3">
            <i data-lucide="info" class="text-indigo-600 w-5 h-5 sm:w-6 sm:h-6"></i> Apa itu Queue?
        </h5>
        <div class="ml-0 space-y-4 sm:space-y-6">
            ...
            <div class="bg-indigo-50 p-3 sm:p-6 rounded-2xl sm:rounded-3xl border border-indigo-100 flex gap-2 sm:gap-4 items-start transition-all hover:shadow-md">
    ...
    <div class="mb-8 sm:mb-16">
        <h5 class="text-lg sm:text-xl md:text-2xl font-extrabold text-slate-800 mb-4 sm:mb-8 flex items-center gap-2 sm:gap-3">
            <i data-lucide="activity" class="text-indigo-600 w-5 h-5 sm:w-6 sm:h-6"></i> Operasi Dasar Queue
        </h5>

        <div class="ml-0 grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-6">
            <div class="p-3 sm:p-6 bg-white border border-slate-100 rounded-xl sm:rounded-[2rem] shadow-sm transition-all hover:border-indigo-200 group">
    ...
    <div class="mb-8 sm:mb-16 bg-slate-900 rounded-2xl sm:rounded-[3rem] p-5 sm:p-8 md:p-12 text-white relative overflow-hidden shadow-2xl shadow-indigo-100">
        ...
        <div class="relative z-10 space-y-3 sm:space-y-4">
            <h5 class="text-lg sm:text-xl md:text-2xl font-bold flex items-center gap-2 sm:gap-3">
                <i data-lucide="zap" class="text-indigo-400 w-5 h-5 sm:w-6 sm:h-6"></i> Mengapa Queue Penting?
            </h5>
    ...
    <div class="mt-20 pt-10 border-t border-slate-100 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between sm:gap-6">
        <a href="{{ url('/materi/operasi-list') }}" class="group w-full sm:w-auto text-slate-400 hover:text-indigo-600 font-bold flex items-center justify-center sm:justify-start gap-2 transition text-sm sm:text-base order-2 sm:order-1 text-center sm:text-left">
            <i data-lucide="arrow-left" class="w-4 h-4 sm:w-5 sm:h-5 group-hover:-translate-x-1 transition-transform hidden sm:block"></i> Kembali ke Operasi List
        </a>
        <a href="{{ url('/materi/simulasi-queue') }}" class="group flex items-center justify-center gap-3 bg-indigo-600 hover:bg-indigo-700 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl sm:rounded-2xl font-bold text-sm sm:text-base transition-all shadow-lg shadow-indigo-200 order-1 sm:order-2 w-full sm:w-auto">
