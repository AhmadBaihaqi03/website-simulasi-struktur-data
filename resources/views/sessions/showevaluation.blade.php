<x-app-layout>
    <style>
        ...
        /* Textarea umpan balik di mobile (dalam konten) */
        ...
        .feedback-textarea-mobile:focus {
            border-color: #5c60f5;
    ...
    <div class="container py-4 py-md-5">
        ...
        <form action="{{ route('groups.evaluate', $group->id) }}" method="POST" id="evalForm">
            ...
            <div class="row g-4">
                ...
                {{-- Panel Evaluasi Guru: HANYA tampil di desktop (kanan, sticky) --}}
                    ...
                    <div class="sticky-panel card card-eval p-4 shadow-lg border-0">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="feedback_comment" class="form-control bg-light border-0 p-3" 
                                rows="6" style="border-radius: 18px; font-size: 1rem; min-height: 130px; resize: vertical;"
                                placeholder="Tulis feedback untuk kelompok ini..." required>{{ $group->evaluation->feedback_comment ?? '' }}</textarea>
                        </div>

                        <button type="submit" class="btn bg-indigo text-white w-100 py-3 fw-bold shadow-lg mb-3" 
                    ...
                    <div class="d-lg-none card card-eval p-4 mb-2" style="border-top: 4px solid #5c60f5;">
                        ...
                        <div class="mt-2">
                            ...
                            <textarea name="feedback_comment" 
                                      class="feedback-textarea-mobile bg-light"
                                      placeholder="Tulis feedback untuk kelompok ini setelah membaca seluruh jawaban di atas..." 
                                      required>{{ $group->evaluation->feedback_comment ?? '' }}</textarea>
                        </div>
                    </div>
    ...
    <div class="d-lg-none fixed-bottom border-top shadow-lg"
        ...
        <div class="d-flex gap-2 align-items-center" style="max-width: 600px; margin: 0 auto;">
            ...
            <button type="submit" form="evalForm"
                ...
                <i class="bi bi-send-fill me-2"></i> SIMPAN UMPAN BALIK
            </button>
        </div>
    </div>
